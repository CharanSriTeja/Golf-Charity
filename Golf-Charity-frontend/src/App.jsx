    ...
    <>
      ...
      <ul className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <div className="mobile-menu-auth">
          <button
            className="btn-outline"
            style={{ flex: 1, padding: "9px 0", fontSize: "13px", textAlign: "center" }}
...
// ── APP ROOT ───────────────────────────────────────────────────────────────
// NOTE: Import these from your actual files — they are referenced here as placeholders
=======
...
export default function App() {
  ...
  useEffect(() => {
    if (location.pathname.startsWith("/how-it-works")) {
      setPage("how-it-works");
    } else if (location.pathname.startsWith("/charities")) {
      setPage("charities");
  ...
  const navigateToPage = (target) => {
    if (target === "charity-detail") {
      if (selectedCharity && selectedCharity.id) {
        setPage("charities");
        navigate(`/charities/${selectedCharity.id}`);
      }
      return;
    }
...
<<<<<<< HEAD
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <>
              ...
              <HomePage setPage={navigateToPage} setSelectedCharity={setSelectedCharity} />
            </>
          }
        />
        ...
        <Route path="/how-it-works" element={
          <>
            <Navbar page={page} setPage={navigateToPage} />
            <HowItWorksPage setPage={navigateToPage} />
          </>
        } />
        <Route path="/charities" element={
          <>
            <Navbar page={page} setPage={navigateToPage} />
            <CharitiesPage setPage={navigateToPage} setSelectedCharity={setSelectedCharity} />
          </>
        } />
        <Route path="/charities/:id" element={
          <>
            <Navbar page={page} setPage={navigateToPage} />
            <CharityDetailPage charity={selectedCharity} setPage={navigateToPage} />
          </>
        } />
        <Route path="/pricing" element={
          <>
            <Navbar page={page} setPage={navigateToPage} />
            <PricingPage setPage={navigateToPage} />
          </>
        } />
        ...
        <Route path="/dashboard/draws" element={<ProtectedRoute><DrawParticipationPage /></ProtectedRoute>} />
        <Route path="/dashboard/winnings" element={<ProtectedRoute><WinningsPage /></ProtectedRoute>} />
        ...
        <Route path="/admin/draws" element={<ProtectedRoute requiredRole="admin"><DrawManagementPage /></ProtectedRoute>} />
        <Route path="/admin/charities" element={<ProtectedRoute requiredRole="admin"><CharityManagementPage /></ProtectedRoute>} />
        <Route path="/admin/payouts" element={<ProtectedRoute requiredRole="admin"><PayoutManagementPage /></ProtectedRoute>} />
        <Route path="/admin/subscriptions" element={<ProtectedRoute requiredRole="admin"><SubscriptionsManagementPage /></ProtectedRoute>} />
        ...
        {/* Redirect unmapped routes to home - single catch-all */}
