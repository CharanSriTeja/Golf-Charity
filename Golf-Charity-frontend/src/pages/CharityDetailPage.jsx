...
export function CharityDetailPage() {
  ...
  useEffect(() => {
    const fetchCharity = async () => {
      try {
        const response = await charitiesAPI.getById(id);
  ...
  if (!charity) {
    return (
      <div style={{paddingTop:120,textAlign:"center"}}>
        ...
        <button className="btn-primary" style={{marginTop:20}} onClick={() => handleNavClick("/charities")}>
          Browse charities
        </button>
      </div>
    );
  ...
  const events = charity.events || [
    { date: "Apr 15, 2026", title: "Fundraising Gala", desc: "Annual fundraising event" },
    { date: "May 3, 2026", title: "Volunteer Drive", desc: "Community volunteering day" },
    { date: "Jun 1, 2026", title: "Impact Report Release", desc: "Quarterly report on outcomes" },
  ];
  ...
  return (
    <div style={{paddingTop:80}}>
      ...
      <div style={{
        background:`linear-gradient(160deg, ${charity.color || "#E8F4FD"} 0%, var(--bg) 100%)`,
        padding:"60px 0 40px"
      }}>
        <div className="container">
          ...
          <div style={{display:"flex",alignItems:"center",gap:20,marginBottom:16}}>
            ...
            }}>{charity.icon || charity.category?.charAt(0) || "C"}</div>
            <div>
          ...
          <div>
            ...
            <div style={{marginBottom:40}}>
              ...
              <p style={{color:"var(--muted)",lineHeight:1.8,fontSize:16}}>
                {charity.description || charity.desc} Their work spans multiple states across India, focusing on sustainable impact and community-led development.
              </p>
            </div>
            ...
            <div style={{marginBottom:40}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
                {[
                  [charity.impact || "10,000+ beneficiaries","Primary metric"],
                  ["FCRA Registered","Legal status"],
                  [charity.foundedYear || "10+ years","Active since"],
                  [charity.budget || "Rs.2Cr+ annual","Budget scale"]
                ].map(([v,l]) => (
                  <div key={l} style={{
          ...
          <div style={{position:"sticky",top:100}}>
            <div style={{
              ...
              <div style={{
                ...
                <div style={{fontFamily:"'Playfair Display',serif",fontSize:48,fontWeight:700,color:"var(--accent)"}}>
                  {charity.donationPercentage || charity.pct || 30}%
                </div>
              </div>
              ...
              <div style={{marginTop:20,fontSize:13,color:"var(--muted)",textAlign:"center",lineHeight:1.6}}>
                All donations verified and receipts issued under 80G of IT Act.
              </div>
            </div>
          </div>
        </div>
